...
(1, "Elli", "Rot", "rot@xyz.de"),		-- Zeichenketten können in '...' bzw. in "..." stehen
...
INSERT INTO Abrechnung(Abrechnung_ID, Kunde_ID, Datum) VALUES
	(1, 1, '2021-05-05'),		-- Datum in Anführungszeichen als String; Datumsformat yyyy-mm-dd einhalten
	(2, 3, '2021-10-07'),		-- 
	(3, 2, '2021-10-11'),
	(4, 3, '2021-10-16'),
	(5, 5, '2021-10-25'),
